...
ENHANCEMENTS:
* `resource/resource_turbot_saml_directory`:  Add argument `allow_idp_initiated_sso` support for Allow IdP-initiated SSO. ([#39](https://github.com/terraform-providers/terraform-provider-turbot/issues/39))
* `resource/resource_turbot_mod`: Add `timeout` block to support `create` timeout. Default value of `create` timeout is 15min ([#53](https://github.com/terraform-providers/terraform-provider-turbot/issues/53))
## 1.5.0 (July 15, 2020)
ENHANCEMENTS:

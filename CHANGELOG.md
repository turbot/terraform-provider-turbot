...
* `resource/resource_turbot_mod`: Add `timeout` block to support `create` timeout. This is the length of time  provider waits for mod installation to complete. Default value of `create` timeout is 15min ([#53](https://github.com/terraform-providers/terraform-provider-turbot/issues/53))
## 1.5.0 (July 15, 2020)
ENHANCEMENTS:
